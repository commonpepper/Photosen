...
interface FlickrApi {
    ...
    @GET("services/rest/?method=flickr.interestingness.getList" + "&extras=date_taken,url_o,url_z,original_format,icon_server,owner_name,o_dims,tags")
    ...
    @GET("services/rest/?method=flickr.people.getPublicPhotos" + "&extras=date_taken,url_o,url_z,original_format,icon_server,owner_name,o_dims,tags")
