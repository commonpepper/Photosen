...
class CommentsViewModelFactory(private val photo_id: String) : ViewModelProvider.Factory {
    ...
    inner class CommentsViewModel : ViewModel() {
        ...
        fun loadComments() {
            ...
            Photosen.flickrApi.getComments(photo_id).enqueue(object : Callback<Comments> {
